<template lang="pug">
	div(style="background: red;").medium-center-margin-wrap medium
	div(style="background: yellow;").large-center-margin-wrap medium-large
	div(style="background: blue;").large-center-margin-wrap large
	div(style="background: purple;").extra-large-center-margin-wrap extra-large
